...
must_haves:
  truths:
    - "Constitution loader merges global + project rules correctly"
    - "Version conflicts detected before merge (major version mismatch throws error)"
    - "Duplicate rule IDs prevented after merge"
    - "Global constitution loaded from ~/.claude/get-shit-done/CONSTITUTION.md"
    - "Project constitution loaded from .planning/CONSTITUTION.md"
    - "Project rules override global rules when rule IDs match"
  artifacts:
    - path: "package.json"
