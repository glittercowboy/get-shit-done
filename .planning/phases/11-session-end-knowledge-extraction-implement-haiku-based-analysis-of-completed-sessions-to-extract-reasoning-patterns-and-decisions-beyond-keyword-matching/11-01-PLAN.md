...
Use CommonJS (`module.exports`) to match existing get-shit-done/bin/ patterns.
  ...
  <verify>
    node -e "const a = require('./get-shit-done/bin/analysis-prompts.js'); console.log(Object.keys(a)); const s = require('./get-shit-done/bin/session-analyzer.js'); console.log(Object.keys(s));"
  </verify>
  <done>
