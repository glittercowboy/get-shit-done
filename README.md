...
> [!TIP]
> **Enhanced Workflows:** Enable `decision_ledger` in your config for even deeper requirements capture — verbatim decision tracking, terminology mapping, and entry point matrices. See `/gsd:help` for all enhancement options.
